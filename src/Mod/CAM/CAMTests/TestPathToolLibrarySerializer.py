...
class TestLinuxCNCLibrarySerializer(TestPathToolLibrarySerializerBase):
    ...
    def test_linuxcnc_serialize(self):
        ...
        self.assertEqual(lines[0], "T1 P0 X0 Y0 Z0 A0 B0 C0 U0 V0 W0 D6.0000 I0 J0 Q0 ;Endmill 6mm")
        self.assertEqual(lines[1], "T2 P0 X0 Y0 Z0 A0 B0 C0 U0 V0 W0 D3.0000 I0 J0 Q0 ;Endmill 3mm")
        self.assertEqual(lines[2], "T3 P0 X0 Y0 Z0 A0 B0 C0 U0 V0 W0 D5.0000 I0 J0 Q0 ;Ballend 5mm")
